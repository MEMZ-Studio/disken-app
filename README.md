...
![GitHub release (latest by date)]([https://github.com/MEMZ-Studio/disken-app/releases/tag/v1.0.0](https://img.shields.io/github/v/release/disken-app/disken))
...
```bash
# 克隆仓库
git clone https://github.com/disken-app/disken.git
cd disken
...
- 项目地址：https://github.com/disken-app/disken
